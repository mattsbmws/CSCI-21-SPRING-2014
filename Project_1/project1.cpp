 ...
 * First programming project Spring 2014, CSCI 21
 *
 * Matt Lindstrom
 * Date created: 2/5/2014
 * Last date modified: 2/5/2014
 *
 * Sample & testing code from Boyd Trolinger
 */
...
/*
 * Count the number of alphabetic characters and 
 ...
 * assume the function will never receive an array of size 0
 * @param values to be averaged in an array
...
/*
 * Find the lowest of the values in an array;
 * assume the function will never receive an array of size 0
 * @param values to be computed in an array
 * @param size of the array being used
